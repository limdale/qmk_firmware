...
[_BL] = LAYOUT_ansi(
  ...
  KC_LCTL, KC_LALT,KC_LGUI,                KC_SPC,                        KC_RALT,KC_CAPS,KC_RCTRL, KC_LEFT,KC_DOWN,KC_RGHT),
...
[_FL] = LAYOUT_ansi(
  ...
  _______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,_______,_______,        _______,KC_END, \
